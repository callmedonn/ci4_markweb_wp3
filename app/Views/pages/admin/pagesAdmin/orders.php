      ...
      <div class="sidebar-start">
        ...
        <div class="sidebar-body">
          ...
          <ul class="sidebar-body-menu">
            ...
            <li>
              <a class="active" href="<?php echo base_url('/admin/order'); ?>"><span class="icon edit"
                ...
                <tbody>
                  <?php foreach ($orders as $order): ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?= base_url('admin/orders/' . $order['id']) ?>" style="background-color: transparent;">
                          <img src="<?= base_url('images/pen-to-square-solid.svg'); ?>">
                        </a>
                        <button style="background-color: transparent;" onclick="deleteOrder(<?= $order['id'] ?>)">
    ...
    <script>
      function deleteOrder(id) {
        ...
        swal({
          ...
          .then((willDelete) => {
            if (willDelete) {
              fetch('http://localhost:8080/order/del/' + id, {
                method: 'DELETE',
                headers: {
