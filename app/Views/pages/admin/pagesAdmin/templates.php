    ...
    <main class="main users chart-page" id="skip-target">
      <div class="container">
        ...
        <div class="row stat-cards">
          ...
          <div class="col-md-6 col-xl-3">
            <article class="stat-cards-item">
              <a href="<?= base_url('admin/addTemplate') ?>" style="text-decoration: none;">
                <button style="background-color: #0061f7; color: white; padding:10px 25px; border-radius: 8px;">Add
                  New</button>
              </a>
            </article>
          </div>
                ...
                <tbody>
                  <?php foreach ($templates as $template): ?>
                    <tr>
                      <td>
                        <label class="users-table__checkbox">
                          <div class="categories-table-img">
                            <picture>
                              <source srcset="<?= base_url('uploads/' . $template['image']) ?>" type="image/webp" />
                              <img src="<?= base_url('uploads/' . $template['image']) ?>" alt="category" />
                            </picture>
                          </div>
                        </label>
                      </td>
                      ...
                      <td>
                        <a href="<?= base_url('admin/templates/' . $template['id']) ?>"
                          style="background-color: transparent;">
                          <img src="<?= base_url('images/pen-to-square-solid.svg'); ?>">
                        </a>
                        <button style="background-color: transparent;" onclick="deleteTemplate(<?= $template['id'] ?>)">
